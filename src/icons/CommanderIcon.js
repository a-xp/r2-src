...
export function CommanderIcon(props) {
    const {color = appColors.resistance, size = 40} = props;
    return (
        <svg viewBox="0 0 296.332 296.332" width={size} height={size}>
            <g>
                <path fill={color} d="M25.953,296.332h244.426c0-61-23.169-94.511-57.946-110.193l-48.621,37.926l-16.313-24.768l-15.313,24.85l-49.117-37.644
                ...
                <path fill={color} d="M147.499,199.352l40.914-20.809c-0.024-0.006-0.049-0.011-0.074-0.017c23.666-13.833,39.577-39.492,39.577-68.883
                ...
                <path fill={color} d="M147.833,89.393c34.568,0,65-14.458,76-20.971V53.601c15-5.669,23.168-12.968,23.168-20.933
