...
export default (props) => {
    const {size = 40, color = "#464646"} = props;
    return (
        <svg x="0px" y="0px" viewBox="0 0 512 512" width={size} height={size}>
            <g>
                <g>
                    <path fill={color} d="M418.88,344.021l-54.869-19.093c-3.989-1.387-8.469-0.277-11.371,2.859c-26.901,29.376-61.227,45.547-96.64,45.547
            ...
            <g>
                <g>
                    <path fill={color} d="M383.893,142.059c0.064-1.131,0.107-2.261,0.107-3.392c0-70.592-57.408-128-128-128s-128,57.408-128,128
            ...
            <g>
                <g>
                    <path fill={color} d="M256,96c-25.131,0-42.667,17.536-42.667,42.667c0,5.888,4.779,10.667,10.667,10.667s10.667-4.779,10.667-10.667
            ...
            <g>
                <g>
                    <circle cx="245.333" cy="256" r="10.667" fill={color}/>
                </g>
            </g>
        </svg>
    )
