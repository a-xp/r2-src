...
export function ResistanceIcon(props) {
    const {size, color = appColors.resistance} = props;
    return (
        <svg viewBox="0 0 296 296" width={size} height={size}>
            <g>
                <path fill={color} d="M270.213,296c0-61-22.546-93.876-57.546-109.694V296H270.213z"/>
                <path fill={color} d="M25.787,296h55.88V186.766C48.667,202.765,25.787,236,25.787,296z"/>
                <path fill={color}
                      d="M147.667,205.006c-18.313,0-35-5.171-50-14.124V296h99V191.486C182.667,200.066,165.563,205.006,147.667,205.006z"/>
                <path fill={color} d="M148,82c39.888,0,74.516,8.21,93.974,13.999c0.001-1.792,0.002-3.523,0.003-5.103c0.002-4.494,0.004-7.783,0.005-7.886
                ...
                <path fill={color} d="M56.381,127.202c4.352-1.337,8.745-2.561,13.162-3.706c6.718,37.246,39.276,65.51,78.457,65.51
